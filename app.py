...
def serper_lens_search():
    ...
    Returns JSON: {"results": [{"title", "link", "source", "thumbnail"}, ...]}
    """
    try:
        data = request.get_json()
